...
var _watch = function(){
  ...
  // compile once, add JavaScript component library, and run the local server when ready
  compiler.mode('dev');
  shell.cp('-rf', path.join(__dirname, '../../node_modules/' + options.css_library) + '/lfa-components', current_directory + "/" + options.output_folder + '/');
  roots.compile_project(current_directory, function(){

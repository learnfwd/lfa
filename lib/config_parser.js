...
module.exports = function(args, cb) {
  ...
  opts.reading_direction = opts.reading_direction || 'ltr';
  ...
  opts.ignore_files = opts.ignore_files || ['_*', '*_partial*', 'readme*', '.gitignore', '.DS_Store', '.*.sw*'];
  ...
  opts.watcher_ignore_files = opts.watcher_ignore_files.concat(['.DS_Store', '.*.sw*']);

...
module.exports = function(args, cb){
  ...
  opts.folder_config = opts.folder_config || { views: 'text', assets: 'text/..', layouts: 'layouts' };
  ...
  opts.ignore_files = opts.ignore_files || ['_*', 'readme*', '.gitignore', '.DS_Store'];
  ...
  opts.ignore_folders = opts.ignore_folders.concat([opts.output_folder, 'plugins', 'layouts']);

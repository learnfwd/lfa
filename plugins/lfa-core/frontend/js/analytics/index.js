define(['app', 'searchjson', 'ua-parser', 'underscore', './keen', './mixpanel', './ga', './intercom'], function(App, SearchJSON, UAParser, _, KeenAnalytics, MixpanelAnalytics, GoogleAnalytics, IntercomAnalytics) {

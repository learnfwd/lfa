// Forked from https://github.com/jtefera/merge-text-webpack
// and updated to Webpack 4
...
mergeFilesWebpack.prototype.apply = function mergeFilesWebpackApply(compiler) {
    ...
    */
    compiler.plugin('emit', (function (compilation, callback) {
        ...
        var newFile = new ConcatSource(...filteredFiles.map(fname => assets[fname]));
